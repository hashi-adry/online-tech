    <!-- Sidebar -->
    <ul class="navbar-nav success-color-dark darken-4 sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">GFT <sup>CLIENT</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="postjob.php">Post Job</a>
            <a class="collapse-item" href="jobscompleted.php">Jobs Completed</a>
            <a class="collapse-item" href="jobsincomplete.php">Jobs in Progress</a>
          </div>
        </div>
      </li>
