...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav secondary-color-dark darken-4 sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">GFT <sup>TECH</div>
      </a>
      ...
      <!-- Nav Item - Clients -->
      <li class="nav-item">
        <a class="nav-link" href="findtech.php">
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="activity.php">Activity Log</a>
          </div>
        </div>
      </li>

      <!-- Nav Item - View Notifications -->
      <li class="nav-item">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-indigo" href="login.html">Logout</a>
        </div>
      </div>
    </div>
  </div>
